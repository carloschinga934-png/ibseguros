      ...
      <div class="layout-container flex h-full grow flex-col">
        ...
        <div class="px-4 md:px-40 flex flex-1 justify-center py-5">
          <div class="layout-content-container flex flex-col w-full md:w-[512px] max-w-[512px] py-5 flex-1">
            <h2 class="text-[#0d141c] tracking-light text-[28px] font-bold leading-tight px-4 text-center pb-3 pt-5">Iniciar sesión</h2>
            ...
            @endif
            <form class="auth-form" action="{{ route('auth.login.post') }}" method="post">
              @csrf
              ...
              <p class="text-[#49709c] text-sm font-normal leading-normal pb-3 pt-1 px-4 underline">¿Olvidaste tu contraseña?</p>
              ...
              <p class="text-[#49709c] text-sm font-normal leading-normal pb-3 pt-1 px-4 text-center">
                ¿No tienes una cuenta? <a href="{{ route('auth.register') }}" class="underline">Regístrate</a>
              </p>
            </form>
          </div>
        </div>
